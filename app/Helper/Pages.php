...
class Pages{
    ...
    public function Loader(){
        ...
        <script src=\"$this->base_url$this->base_dir/assets/vendors/bootstrap/js/bootstrap.bundle.min.js\">
        </script><link href=\"$this->base_url$this->base_dir/assets/css/{$this->Page}-page.css\" rel=\"stylesheet\">";
        return $str;
    }
}
    ...
    switch ($type) {
      ...
      case 'mm':
       // $key = array('فروردین', 'اردیبهشت', 'خرداد', 'تیر', 'مرداد', 'شهریور', 'مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند');
        $key = array('Farvardin', 'Ordibehshet', 'Khordad', 'Tir', 'Mordad', 'Sharivar', 'Mehr', 'Aban', 'Azar', 'Day','Bahman', 'Esfand');
      ...
      case 'km':
      $key = array('Farvardin', 'Ordibehesht', 'Khordad', 'Tir', 'Mordad', 'Sharivar', 'Mehr', 'Aban', 'Azar', 'Day','Bahman', 'Esfand');
